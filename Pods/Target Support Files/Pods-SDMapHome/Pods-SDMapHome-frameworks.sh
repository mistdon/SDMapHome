...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-SDMapHome/MJRefresh.framework"
  install_framework "Pods-SDMapHome/Masonry.framework"
  install_framework "Pods-SDMapHome/ReactiveCocoa.framework"
